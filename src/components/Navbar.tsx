...
import { Database, Link2, Search, User, Lock, Users, Settings, LogIn, LogOut, LayoutDashboard, FilePlus2 } from 'lucide-react';
...
const Navbar = () => {
  ...
  // Define navigation items to make it easier to maintain
  const navItems = [
    { 
      path: '/', 
      label: 'Dashboard', 
